...
class SettingsScreen extends StatefulWidget {
  ...
  /// Réglages persistés (chargés au démarrage par le main screen).
  final Map<String, dynamic> initialSettings;

  /// Remontée du theme mode vers l'app (application immédiate).
  final ValueChanged<int>? onThemeModeChanged;

  /// Applique + reconnecte le daemon quand la config bridge est enregistrée.
...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void initState() {
    ...
    _csrfController = TextEditingController(
      text: (s['csrf'] as String?) ?? '',
    );
    _useSsl = (s['ssl'] as bool?) ?? EnvConfig.useSsl;
    _selectedDefaultModel = (s['defaultModel'] as String?) ?? 'Gemini 3.6 Flash Medium';
  }
      ...
      body: ListView(
        ...
        children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      onPressed: () {
                        ...
                        widget.onDaemonSaved?.call(values);
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    onChanged: (val) {
                      if (val != null) {
                        setState(() => _selectedDefaultModel = val);
                        SettingsStore.save({'defaultModel': val});
                      }
                    },
                  ),
                  const SizedBox(height: 12),
          ...
          AppearanceSettingsSection(
            initialIndex: ((widget.initialSettings['themeMode'] as int?) ?? 0).clamp(0, 2),
