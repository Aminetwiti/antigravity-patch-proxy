...
> `antigravity-patch-proxy` v3.0.0 — Desktop Electron proxy that injects custom LLM models (Claude, GPT, DeepSeek, Ollama, etc.) into Google Antigravity IDE.
...
npm run patch:2.3               # Apply Antigravity 2.3.x patch
...
- **Binary patch is version-sensitive** — separate scripts for 2.2.1 vs 2.3.x
